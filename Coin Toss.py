...
'''
       ...
       for count in range(10):
           ...
           #my_coin.sideup = "Heads" - this would make every time heads but since the __ is before the sideup 
           #attribute is hidden and this line won't affect the random results  
